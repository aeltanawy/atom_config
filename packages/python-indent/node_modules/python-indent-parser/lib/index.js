...
function nextIndentationLevel(parseOutput, lines, tabSize) {
    ...
    var openBracketStack = parseOutput.openBracketStack, lastClosedRow = parseOutput.lastClosedRow, lastColonRow = parseOutput.lastColonRow, dedentNext = parseOutput.dedentNext;
...
function parseLines(lines) {
    ...
    var dedentNextKeywords = [/^\s*return\b/, /^\s*pass\b/, /^\s*break\b/, /^\s*continue\b/, /^\s*raise\b/];
    ...
    var _loop_1 = function (row) {
        var line = lines[row];
        dedentNext = (stringDelimiter === null) && dedentNextKeywords.some(function (word) { return line.search(word) >= 0; });
    ...
    return {
        canHang: canHang, dedentNext: dedentNext, lastClosedRow: lastClosedRow, lastColonRow: lastColonRow, openBracketStack: openBracketStack,
    };
}
