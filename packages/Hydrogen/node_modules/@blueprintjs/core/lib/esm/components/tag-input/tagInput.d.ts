...
export declare class TagInput extends AbstractPureComponent2<ITagInputProps, ITagInputState, ITagInputSnapshot> {
    static displayName: string;
    static defaultProps: Partial<ITagInputProps> & object;
    state: ITagInputState;
    private inputElement;
    private refHandlers;
    getSnapshotBeforeUpdate(prevProps: Readonly<ITagInputProps>): ITagInputSnapshot;
    componentDidUpdate(_: ITagInputProps, __: ITagInputState, snapshot: ITagInputSnapshot): void;
    render(): JSX.Element;
    private addTags;
