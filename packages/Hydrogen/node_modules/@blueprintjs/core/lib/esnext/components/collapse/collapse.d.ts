...
export declare class Collapse extends AbstractPureComponent2<ICollapseProps, ICollapseState, ICollapseSnapshot> {
    ...
    private contents;
    private height;
    getSnapshotBeforeUpdate(prevProps: ICollapseProps): ICollapseSnapshot;
    render(): React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)>;
    componentDidMount(): void;
    componentDidUpdate(_: ICollapseProps, __: ICollapseState, snapshot: ICollapseSnapshot): void;
