...
export declare class NumericInput extends AbstractPureComponent2<HTMLInputProps & INumericInputProps, INumericInputState, INumericInputSnapshot> {
    static displayName: string;
    static VALUE_EMPTY: string;
    static VALUE_ZERO: string;
    static defaultProps: INumericInputProps;
    static getDerivedStateFromProps(props: INumericInputProps): {
        stepMaxPrecision: number;
    };
    ...
    getSnapshotBeforeUpdate(prevProps: INumericInputProps): INumericInputSnapshot;
    render(): JSX.Element;
    componentDidUpdate(prevProps: INumericInputProps, prevState: INumericInputState, snapshot: INumericInputSnapshot): void;
